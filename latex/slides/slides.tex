...
\begin{document}
	...
	\begin{frame}
		...
		\begin{itemize}
			\item In \highlight{1949}, females made up \highlight{40\% of the total labour force} both in the GDR and in the FRG.
			\item Unlike the West German females, \highlight{East German females remained in the labour market} after the economic upturn in the 1960s \textcolor{darkgray}{\citep{Menschik1974}}.
		\end{itemize}
		...
		{\linespread{1}\tiny
			\begin{table}[h]
				...
				\begin{tabular}{l*{4}{c}}
					...
					&    (0.0093)         &    (0.0093)         &    (0.0323)         &    (0.0322)         \\
					\addlinespace
					Years after Reunification $\times$ Female&    \textcolor{PineGreen}{-0.0093\sym{***}}&     -0.0075\sym{***}&     -0.0074\sym{***}&     -0.0053\sym{**} \\
					&    \textcolor{PineGreen}{(0.0021)}        &    (0.0022)         &    (0.0022)         &    (0.0022)         \\
					\midrule
					Residence in West Germany&                     &      0.0503\sym{**} &      0.0569\sym{**} &      0.0626\sym{***}\\
					&                     &    (0.0226)         &    (0.0225)         &    (0.0227)         \\
					\addlinespace
		...
		{\linespread{1}\tiny
			\begin{table}[h]
				...
				\begin{tabular}{l*{4}{c}}
					...
					&    (0.0093)         &    (0.0093)         &    (0.0323)         &    (0.0322)         \\
					\addlinespace
					Years after Reunification $\times$ Female&     -0.0093\sym{***}&    \textcolor{PineGreen}{ -0.0075\sym{***}}&     -0.0074\sym{***}&     -0.0053\sym{**} \\
					&    (0.0021)         &    \textcolor{PineGreen}{(0.0022)}         &    (0.0022)         &    (0.0022)         \\
					\midrule
					Residence in West Germany&                     &      \textcolor{PineGreen}{ 0.0503\sym{**}} &      0.0569\sym{**} &      0.0626\sym{***}\\
					&                     &    \textcolor{PineGreen}{(0.0226)}        &    (0.0225)         &    (0.0227)         \\
					\addlinespace
					Residence in West Germany $\times$ Female&                     &     \textcolor{PineGreen}{-0.0755\sym{**}} &     -0.0631\sym{*}  &     -0.0718\sym{**} \\
					&                     &    \textcolor{PineGreen}{(0.0337)}        &    (0.0329)         &    (0.0331)         \\
					\midrule
					Observations        &       19,428         &       19,428         &       19,428         &       19,428         \\
					\bottomrule
				\end{tabular}
