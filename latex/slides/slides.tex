...
\begin{document}
	...
	\begin{frame}
		...
		\begin{itemize}
			\item How do social norms influence our occupational decisions?
			\item Do social norms persist when the institutions that uphold them vanish?
			\item Consider these questions with regard to Eastern females who work in traditionally male-dominated work sectors after the socialist GDR collapses.
		\end{itemize}
	...
	\begin{frame}
		...
		\begin{itemize}
			...
			\item Group by: \highlight{East origin} (location in 1989) and \highlight{sex}.
	...
	\begin{frame}
		...
		\begin{itemize}
			...
			\end{itemize}
			\item Regressor of interest: \highlight{years after unification $\times$ being female}.
		\end{itemize}
	...
	\begin{frame}
		...
		\begin{itemize}
			\item Effect driven by Attrition?
			\item New panel entrants?
		\end{itemize}
