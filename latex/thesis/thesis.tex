...
Now, the effect of having any parent with a STEM background reads 8 pp.
...
Comparing the full unrestricted model with the alternative regressand with the main results presented in the intensive analysis on daughters shows that the coefficients do not notably chang, except that the coefficient for having a father from the East increases from 6 pp to 17 pp.
...
This confirms our results from the main analysis and shows that the opposite-sex parent channel of influence is strengthened when the definition of STEM is conformed.
