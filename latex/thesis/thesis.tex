...
The results of the analysis, when considered alongside the findings of the descriptive analysis, suggest the following working theory:
...
Added to this is the fact that the people in the GDR were oppressed by their political system and that the economic system led to constant shortages in supplies, which led to general dissatisfaction.
...
So, alongside the state of the GDR, its ideology failed as well.
