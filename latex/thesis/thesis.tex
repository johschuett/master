...
\begin{table}[ht]
	...
	\begin{center}
		\begin{tabular}{l*{3}{c}}
			...
			&         () &       ()&  ()\\
			\addlinespace
			Mother: East German Origin &     &     &         \\
			&         () &   ()&  ()\\
			\addlinespace
			Father: East German Origin &     &     &         \\
			&         () &       ()&  ()\\
			\addlinespace
			Mother: Ever STEM Profession &    &     &     \\
			&         () &       () &  () \\
			\addlinespace
			Father: Ever STEM Profession &     &     &     \\
			&         () &       ()&  ()\\
			\addlinespace
...
\begin{landscape}
	\begin{table}[ht]
		\caption{Extensive Margins (University Degree or Vocational Degree) for Daughters}
...
\begin{landscape}
	\begin{table}[ht]
		\caption{Extensive Margins (University Degree or Vocational Degree) for Sons}
		\label{tab:extsons}
		\begin{center}
			\resizebox{1.24\textwidth}{!}{\begin{tabular}{l*{6}{c}}
					\toprule
...
\begin{landscape}
	\begin{table}[ht]
		\caption{Intensive Margins (STEM University Degree or non-STEM University Degree) for Daughters}
...
\begin{landscape}
	\begin{table}[ht]
		\caption{Intensive Margins (STEM University Degree or non-STEM University Degree) for Sons}
		\label{tab:intsons}
		\begin{center}
			\resizebox{1.24\textwidth}{!}{\begin{tabular}{l*{6}{c}}
					\toprule
