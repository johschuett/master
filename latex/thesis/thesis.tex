...
Suppose now that the disutility of studying a STEM subject can be characterised by the standard normal cumulative distribution $\Phi{}(x)$ evaluated at $x$, then
...
\noindent where $\phi(x)$ is the pdf of the standard normal distribution. Similarly, marginally increasing non-STEM wages $w_{1,k}$ leads ceteris paribus to a decrease as well, i. e.
...
Finally, consider the situation of females in reunified Germany with parental roots $k \in \{\textnormal{GDR, FRG}\}$ who are confronted with the same decision regarding whether to study a STEM subject or not.
