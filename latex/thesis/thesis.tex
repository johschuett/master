...
% further steps
% In particular, the policy manifested itself through thehigh availability of childcare facilities, free availability of contraceptives, legal abortionrights, and the promotion of the ideological obligation to work (Einhorn, 1993; Budde,1999; Nickel, 1998). Although these measures were mainly motivated by economiccircumstances, e.g. post-war labour shortage and migration towards the FRG, theyassigned women a more equal role in society (Budde, 1999; Lang, 2017).
% but, almost no females in leading positions in jobs
